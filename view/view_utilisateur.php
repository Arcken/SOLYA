        ...
        <form class="form" onsubmit="return verifPass()">
            <div class="col90">
                ...
                <input name="utLogin" placeholder="Texte" type="text" required=""  
                       autocomplete="off" pattern=".{3,}" title="3 caractéres minimum"
                ...
                <input name="utPass" id='pass' placeholder="Au moins 8 caractères" 
                       autocomplete="off" pattern=".{8,}" title="8 caractéres minimum"
                       onblur='verifPassForce()' type="password" required=""> 
                <a id='passForce'></a>
                <br>
                <label for="utPass2"> Confirmation: </label>
                <input name="utPass2" id='confirmPass' placeholder="Mot de passe" 
                       type="password" required="" onkeyup='verifPassImg()'>
